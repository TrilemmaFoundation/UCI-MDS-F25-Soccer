...
def plot_interactive_shot_map(df_shots, team_name):
    ...
    team_shots["hover_text"] = team_shots.apply(
        lambda row: f"Player: {row['player']}<br>"
...
# ------------------------------
    ...
    if "team" in df_events.columns:
        ...
        # ------------------------------
        # Interactive Shot Maps with xG
        # ------------------------------
        st.markdown("### Shot Maps (Interactive - Hover for xG)")
        ...
        # ------------------------------
        # Standard Heatmaps for Pass and Ball Receipt
        # ------------------------------
        event_types = ["Pass", "Ball Receipt"]
        event_titles = ["Pass Heatmap", "Ball Receipt Heatmap"]
